...
<br />
Twitterライクな会話用アプリケーションです<br/><br/>
ツイートやリプライ、ユーザー間のフォロー・アンフォロー、投稿に対するリアクションができます。<br />
Heroku + fog + AWS S3にてデプロイ。レスポンシブ対応｡<br />
...
<h4> ダッシュボード画面を中心とした画面遷移</h4><br />
画面上、ほとんどの要素がクリック可能になっています。なるべくスムーズで直感的な操作ができるように意図しました。  
...
2017/2/14 ソーシャルログイン機能を追加（facebook/twitter）  
2017/3/1  一部リファクタリング､N+1問題に関連してSQLを修正
